...
import { FormAceEditor, useErrorMessage } from "../Form";
                ...
                <Tab
                    ...
                    title={
                        <div className={classNames({ "text-danger": sampleObjectError.hasErrors })}>
                            ...
                            {sampleObjectError.hasErrors && <Icon icon="warning" color="danger" margin="ms-1" />}
                        </div>
                    }
                >
                    <div>
                ...
                <Tab
                    ...
                    title={
                        <div>
                            ...
                            {jsonSchemaError.hasErrors && <Icon icon="warning" color="danger" margin="ms-1" />}
                        </div>
                    }
                >
                    <div>
