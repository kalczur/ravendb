...
class shell extends viewModelBase {
    ...
    constructor() {
        ...
        this.isHelpAndResourcesWidgetVisible = ko.pureComputed(() => {
            const routesToHide: string[] = ["databases/ai/agents/edit", "databases/ai/agents/chat", "databases/documents", "databases/documents/allDocuments/reactLazyLoad", "databases/documents/allDocuments/reactPagination"];
    ...
    urlForAllDocumentsReactLazyLoad() {
        return appUrl.forAllDocumentsReactLazyLoad(this.activeDatabase());
    }

    urlForAllDocumentsReactPagination() {
        return appUrl.forAllDocumentsReactPagination(this.activeDatabase());
    }
